...
export default function Billing() {
    ...
    const [suggestedBalance, setSuggestedBalance] = useState();
    ...
    return <div class="w-full flex flex-col items-center text-center text-2xl gap-8 p-4">
        ...
        <div class="flex flex-col items-center gap-1">
            ...
            <input type="string" class="border-1 w-80 px-2 py-3" onChange={e => setSuggestedBalance(e.target.value ? Math.ceil(parseFloat(e.target.value) * 0.329) : '')} />
